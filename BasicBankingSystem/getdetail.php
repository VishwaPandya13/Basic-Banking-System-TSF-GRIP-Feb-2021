...
<body>	
    ...
    <table class="flat-table-1">
		...
		<tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Preyash">View</button>
				</form>
			</td>
		</tr>
        <tr>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Rita">View</button>
				</form>
			</td>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Taral">View</button>
				</form>
			</td>
		</tr>
        <tr>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Masum">View</button>
				</form>
			</td>
        </tr>
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Ankita">View</button>
				</form>
			</td>
		</tr>
		</tbody>
